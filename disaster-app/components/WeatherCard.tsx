...
export default function WeatherCard({ weather, location }: any) {
  ...
  return (
    <View style={{
      backgroundColor: "#3B82F6", borderRadius: 24, padding: 24, paddingVertical: 40,
      ...
      <View style={{ flexDirection: "column", alignItems: "center" }}>
        ...
        <Text style={{ color: "#E5E5E5", marginTop: 5, fontSize: 12, marginBottom: 5 }}>
          <Feather name="wind"/> {weather.wind}{t('wind')} | <Ionicons name="water" style={{color:"#E5E5E5"}}/> {weather.humidity}{t('humidity')}
        </Text>
      ...
      <View style={{ alignItems: "center" }}>
        ...
        <Text style={{ color: "#F8F8F8", marginTop: 5, fontSize: 14 }}>{weather.weatherType || "Partly Cloudy"}</Text>
      </View>
    </View>
  );
}